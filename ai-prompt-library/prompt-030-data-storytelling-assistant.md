...
Vytvořit přehledný **Data Storytelling Plan**, který propojí business kontext, hlavní analytická zjištění, doporučené vizualizace a logickou strukturu prezentace do jednoho konzistentního příběhu.

Prompt pomáhá jednoznačně oddělit:

- business kontext,
- hlavní sdělení,
- potvrzené analytické výsledky,
- doporučené pořadí prezentace,
- interpretační omezení,
- navazující analytické kroky.

Data Storytelling Plan slouží jako podklad pro management prezentace, Power BI reporty, dashboardy, Executive prezentace i business komunikaci.
...
- vytvoření datového příběhu z dokončené analýzy,
- návrh struktury prezentace analytických výsledků,
- propojení insightů do logického příběhu,
- příprava management prezentace,
- návrh pořadí jednotlivých vizualizací,
- příprava podkladů pro prezentaci Power BI dashboardů.

## Business scénáře

- prezentace výsledků Root Cause Analysis,
- prezentace KPI analýzy,
- prezentace EDA,
- prezentace obchodních výsledků,
- prezentace finanční analýzy,
- prezentace zákaznické analytiky,
- prezentace marketingové analytiky,
- management reporting,
- Executive prezentace.

## Typické úlohy

- vytvoření logické struktury prezentace,
- propojení insightů do jednoho příběhu,
- definice hlavního sdělení,
- návrh pořadí prezentovaných výsledků,
- doporučení vhodné vizuální podpory,
- formulace klíčových momentů příběhu,
- vymezení interpretačních omezení,
- příprava závěrečného sdělení,
- návrh analyticky podložených navazujících kroků.

---

# Prompt - revidovaná verze (po revizi a optimalizaci prostřednoctvím Prompt Reviewer & Optimizer)
...
1. Shrnutí příběhu
2. Předpoklady
3. Cílové publikum a komunikační cíl
4. Hlavní sdělení
5. Struktura datového příběhu
6. Klíčové momenty příběhu
7. Omezení a interpretační upozornění
8. Závěrečné sdělení
9. Podložené navazující kroky

Dodrž následující pravidla:

- piš stručně a věcně,
- zachovávej logickou návaznost jednotlivých částí příběhu,
- nevytvářej nové analytické závěry,
- neformuluj nepodložené příčiny,
- jasně odděluj fakta od předpokladů,
- navrhuj pouze vizualizace odpovídající dostupným výsledkům,
- nepopisuj technickou implementaci,
- neopakuj stejné informace mezi jednotlivými částmi dokumentu.

Výstup by měl odpovídat přibližně rozsahu 2–3 stran textu.

---

# Prompt - původní verze
...
- převádí dokončenou analýzu do logicky strukturovaného datového příběhu,
- propojuje business kontext s analytickými výsledky,
- vytváří konzistentní strukturu management prezentace,
- navrhuje vhodné pořadí jednotlivých částí prezentace,
- doporučuje vhodnou vizuální podporu jednotlivých částí příběhu,
- odděluje potvrzené výsledky od interpretačních omezení,
- zabraňuje vytváření nepodložených kauzálních závěrů,
- zachovává objektivní interpretaci analytických výsledků,
- vytváří podklad pro prezentace, dashboardy i Executive reporting,
- podporuje efektivní komunikaci analytických výsledků managementu a business stakeholderům,
- minimalizuje halucinace při převodu analytických výsledků do business prezentace.
